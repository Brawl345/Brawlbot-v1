-- Basiert auf https://github.com/nerdclub-tfg/telegram-bot/blob/plugin_fefe/plugins/fefe.lua

local function fefepost(id)
  local url = 'http://'..id
  local results, code = http.request(url)
...
local function run(msg, matches)
  return fefepost(matches[1])
end

return {
  description = "Sendet blog.fefe.de Posts",
  usage = "Link zu einem Beitrag auf Fefes Blog",
  patterns = {
